...
namespace toys.test
{
    ...
    public class DateTimeExtensionTest
    {
        ...
        public void ShouldReturnCorrectVietnameseTimeAgo()
        {
            ...
            Assert.AreEqual("29 ngày trước", now.AddDays(-29).ToTimeAgo());
            Assert.AreEqual("1 tháng trước", now.AddDays(-32).ToTimeAgo());
            Assert.AreEqual("1 tháng trước", now.AddDays(-50).ToTimeAgo());
